...
% through a distributed key generation process. \cite{sharma2021}
    ...
    \textit{Pedersen commitment} \cite{pedersen1991}. Los compromisos (\texit{commitments}) son secretamente revelados al subastador vía
...
% Knowledge Succinct Non-interactive ARgument of Knowledge (zk-SNARK) set up. \cite{sharma2021}
    
    % The proposed scheme
    % implements the validity, fairness, secrecy of the auction
    % transaction. However, the proposed scheme depended on the
    % third-party auctioneer \cite{li2021}
